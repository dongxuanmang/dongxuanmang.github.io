...
**大写强调有效，但会稀释。** 大写字母（"NEVER do X"）比 "Please avoid doing X" 更能引起模型的注意——Claude Code 的工具定义里就有 "NEVER invoke grep or rg as a Bash command"。但过度使用会导致效果被稀释，大写要留给真正关键的约束。
