...
| 章 | 主题 | 官方难度 | 我的理解与输出 |
| :--: | --- | :--: | :--: |
| 1 | AI Agent 入门：三要素、ReAct 循环、Harness 工程 | 🟢 | ✅ [能力边界由 Harness 决定](/2026/09/15/agent-book-ch1-harness/) · [模型即 Agent？循环只是搬到了服务端](/2026/09/16/agent-book-ch1-model-as-agent/) · [从 Demo 到生产，隔着 Harness](/2026/09/16/agent-book-ch1-engineering/) |
